...
public class StandardItemStrategyTests
{
    ...
    {
        // Arrange
        var item = new Item { Name = "Any Standard Item", SellIn = 5, Quality = 10 };
    ...
    {
        // Arrange
        var item = new Item { Name = "Any Standard Item", SellIn = 0, Quality = 10 };
    ...
    {
        // Arrange
        var item = new Item { Name = "Any Standard Item", SellIn = 5, Quality = 0 };
    ...
    {
        // Arrange
        var item = new Item { Name = "Any Standard Item", SellIn = 0, Quality = 1 };
